...
class RenderBlocking {
	...
	static function set_js(){
		...
		if(!empty($speedycache->options['render_blocking_exclude'])){
			$exclude_script_list = array_map('preg_quote', $speedycache->options['render_blocking_exclude'], array_fill(0, count($speedycache->options['render_blocking_exclude']), '/'));
