...
class tds_util {
		...
		if ( null !== $subscriptions ) {
			...
			if ( count( $subscriptions ) ) {
				...
				foreach ( $subscriptions as &$subscription ) {
                    ...
                    $subscription['billing_country'] = tds_util::get_country_name( $subscription['billing_country'] );
	...
	static function get_country_iso_code( $country_name = '' ) {
        ...
        $countries = array_flip( self::get_countries() );
	...
	static function get_country_name( $country_iso_code = '' ) {

        $countries = self::get_countries();

		if ( !empty($countries[$country_iso_code]) ) {
    ...
    static function get_custom_pagination( $current_page, $num_pages, $url_param, $pages_to_show = 3, $classes = [ 'wrapper' => '', 'item' => '', 'active' => '', 'dots' => '' ] ) {
