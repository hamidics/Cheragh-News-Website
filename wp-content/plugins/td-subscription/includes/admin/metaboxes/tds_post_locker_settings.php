...
//                    $current_state = get_select_state( $locker, $mb->get_the_value());
                    $current_state = '';
                    $tds_locker_types = get_post_meta( $locker->ID, 'tds_locker_types', true );
                    if ( ( !empty( $tds_locker_types['tds_locker_slug'] ) && $mb->get_the_value() === $tds_locker_types['tds_locker_slug'] ) || ( is_numeric( $mb->get_the_value() ) && $locker->ID === intval( $mb->get_the_value() ) ) ) {
